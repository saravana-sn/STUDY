package com.saravana.library.contoller;
...
import com.saravana.library.service.LibraryService;
...
public class LibraryController {
    ...
    @GetMapping("/books/search/title/{query}")
    public ResponseEntity<List<Book>> searchByTitle(@PathVariable String query) {
        List<Book> res = libraryService.searchBooksByTitle(query);
        logger.info("The user searched(by title) for "+ query+" and got result: "+res);
        return new ResponseEntity<>(res, HttpStatus.OK);
    }

    @GetMapping("/books/search/author/{query}")
    public ResponseEntity<List<Book>> searchByAuthor(@PathVariable String query) {
        List<Book> res = libraryService.searchBooksByAuthor(query);
        logger.info("The user searched(by author) for "+ query+" and got result: "+res);
        return new ResponseEntity<>(res, HttpStatus.OK);
    }
