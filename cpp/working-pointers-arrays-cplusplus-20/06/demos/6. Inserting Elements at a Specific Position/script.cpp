...
void printSubjectIds(const std::vector<Subject> &subjects)
{
  // subjects.size();
...
int main()
{
  ...
  subjects.reserve(5);
  subjects.emplace_back(1, "CGTA");
  subjects.emplace_back(2, "CGAT");
  subjects.emplace_back(3, "GCAT");
  subjects.emplace_back(2, "CGAT");
  subjects.emplace_back(4, "GCTA");
  printSubjectIds(subjects);
  // subjects.insert(subjects.begin() + 2, Subject(8, "GCTA"));
  subjects.emplace(subjects.begin() + 2, 8, "GCTA");
  printSubjectIds(subjects);
}