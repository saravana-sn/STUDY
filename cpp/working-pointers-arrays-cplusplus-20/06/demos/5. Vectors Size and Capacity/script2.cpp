...
int main()
{
  ...
  std::cout << "size: " << subjects.size() << " capacity: "
            << subjects.capacity() << std::endl;
  subjects.reserve(3);
  std::cout << "size: " << subjects.size() << " capacity: "
            << subjects.capacity() << std::endl;
  subjects.push_back(Subject(3, "CGTA"));
  subjects.push_back(Subject(6, "CGTA"));
  subjects.push_back(Subject(8, "CGTA"));
  std::cout << "size: " << subjects.size() << " capacity: "
            << subjects.capacity() << std::endl;
